...
import { type Options, coreLoginDestroy, coreLoginRetrieve, coreLoginCreate, coreQrAuthRetrieve, coreQrAuthCreate, coreQrAuthUpdate, coreStreamRetrieve } from '../sdk.gen';
import { type UseMutationOptions, type DefaultError, queryOptions } from '@tanstack/react-query';
import type { CoreLoginDestroyData, CoreLoginDestroyResponse, CoreLoginRetrieveData, CoreLoginCreateData, CoreLoginCreateResponse, CoreQrAuthRetrieveData, CoreQrAuthCreateData, CoreQrAuthUpdateData, CoreStreamRetrieveData } from '../types.gen';
...
export const coreStreamRetrieveQueryKey = (options?: Options<CoreStreamRetrieveData>) => createQueryKey('coreStreamRetrieve', options);

export const coreStreamRetrieveOptions = (options?: Options<CoreStreamRetrieveData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await coreStreamRetrieve({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: coreStreamRetrieveQueryKey(options)
    });
};