...
import type { CoreLoginDestroyData, CoreLoginDestroyResponse, CoreLoginRetrieveData, CoreLoginCreateData, CoreLoginCreateResponse, CoreQrAuthRetrieveData, CoreQrAuthCreateData, CoreQrAuthCreateResponse, CoreQrAuthUpdateData, CoreQrAuthUpdateResponse } from '../types.gen';
 ...
 * QR Management API View
 */
export const coreQrAuthUpdateMutation = (options?: Partial<Options<CoreQrAuthUpdateData>>): UseMutationOptions<CoreQrAuthUpdateResponse, AxiosError<DefaultError>, Options<CoreQrAuthUpdateData>> => {
    const mutationOptions: UseMutationOptions<CoreQrAuthUpdateResponse, AxiosError<DefaultError>, Options<CoreQrAuthUpdateData>> = {
        mutationFn: async (fnOptions) => {
